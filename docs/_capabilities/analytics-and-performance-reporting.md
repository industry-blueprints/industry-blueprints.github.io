---
id: analytics-and-performance-reporting
title: Analytics & Performance Reporting
type: capability
level: 2
version: '0.1'
status: draft
description: Turning operational data into measures, dashboards, and published performance
  information — and getting anyone to act on it.
...
first contact resolution for what it takes to measure the harder
one honestly.
