...
version: '0.1'
status: draft
description: Acquiring, maintaining, assigning, fuelling, and disposing of vehicles
  and equipment — where replacement deferral is the most reliably expensive saving
  available.
...
same obligation tracking gap seen in construction warranties.
## Architecture
