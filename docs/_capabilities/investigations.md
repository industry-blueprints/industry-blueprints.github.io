...
## Lifecycle
Allegation Intake & Track Determination —
...
with the basis for opening or declining · **investigative case file with
...
| Track determined before subject contact | Process |
...
audit findings closed only after addressing cause.
...
Investigative Track & Rights Advisement
— the control around the decisions with no recovery path. It has **no remediation step** because
none is available: once the compelled
