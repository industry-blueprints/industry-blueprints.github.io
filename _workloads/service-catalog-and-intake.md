...
**People arrive with a problem, not a service name.** The catalog exists so the organization can
...
1. Service definition and cataloguing
2. service owner assignment
3. eligibility and requirement documentation
4. channel design and parity review
5. form design and rationalization
6. intake routing and case creation
7. reference number issue and acknowledgement
8. service level publication
9. catalog review and retirement
10. demand analysis by service and channel
...
The last measure is the honest test of the catalog. Volume there means the front door is not
