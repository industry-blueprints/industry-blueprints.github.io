...
1. Intake, packaging, and barcoding at the point of seizure
2. chain of custody recording on every transfer
3. storage assignment by category and condition
4. high-value and narcotics vault control
5. firearm handling and tracing submission
6. release to laboratory and return
7. court production and return
8. digital evidence ingest, hashing, and integrity verification
9. retention determination against case status
10. owner notification and return
11. lawful disposal, destruction, and auction
12. periodic and unannounced inventory audit
13. purge programs to reduce backlog
...
justice information sharing failure showing up as a
storage crisis.
