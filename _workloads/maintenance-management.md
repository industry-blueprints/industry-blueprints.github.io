...
2. Work Order Planning & Scheduling
3. Field Execution & Completion
4. Failure Analysis & Renewal Referral Also: backlog management
5. parts and inventory coordination
6. contractor maintenance oversight

## Outcomes and Measures

- Preventive program derived from criticality and failure consequence, not from a uniform interval
...
- Failure causes analyzed for the recurring ones
...
deferred maintenance backlog is growing whatever
