...
3. treatment selection and assignment
4. control design and testing
5. insurance placement and renewal
6. claims intake, investigation, and settlement
7. loss run analysis
8. recovery and subrogation
...
- Claims handled promptly and analyzed for cause
