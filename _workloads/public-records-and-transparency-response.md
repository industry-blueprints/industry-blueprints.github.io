...
To fulfill the public's right of access to government information: locate responsive records,
...
a clock.** That reconciliation is a judgment call with real consequences in both directions —
...
1. Request intake and acknowledgement
2. clarification and scoping
3. fee estimation
4. search across systems and custodians
5. responsiveness review
6. exemption analysis
7. redaction
8. release and partial-denial notice
9. appeal handling
10. proactive publication of frequent subjects
