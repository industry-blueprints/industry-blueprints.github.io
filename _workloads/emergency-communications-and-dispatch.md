...
contact centre — the same intake, triage, routing,
...
1. Call answering and initial interrogation
2. location determination and verification
3. caller triage by protocol — medical, fire, police
4. emergency medical dispatch pre-arrival instruction
5. call prioritization and unit recommendation
6. dispatch and unit status management
7. alternative response routing — behavioral health, non-emergency, online reporting
8. responder support and information relay during the incident
9. mutual aid and interoperable communications
10. text, video, and data intake
11. abandoned and misdial handling
12. language interpretation on the line
13. quality assurance review
14. critical incident support for staff
...
- Interoperable communications with mutual aid and neighboring agencies
