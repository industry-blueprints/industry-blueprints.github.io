...
1. Meeting notice and agenda publication
2. minutes and record production
3. executive session justification and record
4. open data inventory and prioritization
5. dataset publication and refresh
6. data quality and de-identification review
7. consultation design and channel selection
8. outreach to under-represented groups
9. input analysis and disposition
