...
money, and it is not.** The award covers the program. It does not cover the reporting, the
...
1. Grant Pursuit & Acceptance Decision
2. Drawdown, Reporting & Closeout
3. Subrecipient Risk Assessment & Monitoring (where the organization also passes funds through)
...
- Reporting produced accurately without consuming the program
