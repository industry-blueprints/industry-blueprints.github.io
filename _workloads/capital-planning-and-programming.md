...
them against available funding, and maintain a program that reflects condition and need rather
...
debt. Renewal of an asset that still works is none of
...
1. Needs identification from asset condition
2. level-of-service definition
3. project scoping and cost estimation
4. whole-life cost analysis
5. prioritization and scoring
6. funding source identification and matching
7. multi-year program development
8. annual capital budget adoption
9. program re-baselining
10. grant and external funding pursuit
11. public and stakeholder consultation on the program

## Outcomes and Measures

- A capital program driven by condition and level-of-service evidence, not by advocacy
...
- A program that survives a change of administration in some recognizable form
...
| Program delivered against program planned | Output |
