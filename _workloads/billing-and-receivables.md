...
1. Charge determination and rate application
2. invoice generation and delivery
3. payment acceptance and allocation
4. account maintenance and adjustment
5. dunning and escalation
6. payment plan and hardship assessment
7. fee waiver and reduction
8. third-party collection referral
9. write-off authorization
10. refund and overpayment handling
...
programs when it is finally computed, and it is rarely computed.
