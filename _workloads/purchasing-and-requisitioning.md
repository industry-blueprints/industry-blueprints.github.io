...
1. Catalog and contract price list maintenance
2. requisition creation and approval routing
3. funds check and encumbrance
4. purchase order issue and transmission
5. order amendment
6. goods and service receipting
7. invoice matching and exception handling
8. purchasing card issuance, limits, and reconciliation
9. emergency and after-the-fact purchase authorization
10. spend analysis
...
- Card programs with real, timely oversight rather than annual sampling
