...
conditions on labor charging all apply to the same paycheck. Complexity here is not a sign of
...
6. labor distribution and grant charging
...
- Labor cost distributed to the right fund, project, and award when incurred
...
| Labor cost distributed at source versus reallocated later | Process |
