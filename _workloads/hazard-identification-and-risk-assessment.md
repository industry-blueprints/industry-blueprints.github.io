...
neighborhoods in the same flood zone have the same exposure and very different capacity to
...
2. historical event research
3. likelihood and frequency estimation
4. consequence and loss estimation modelling
5. exposure analysis against assets and population
6. social vulnerability assessment
7. critical facility exposure review
8. climate projection incorporation
9. risk ranking and prioritization
10. mitigation strategy identification and benefit-cost analysis
11. hazard mitigation plan development and adoption
12. plan update on the required cycle
...
- Findings actually used in land use,
  capital, and preparedness decisions
