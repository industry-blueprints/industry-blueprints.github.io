...
management, with staff as the constituents.** The
...
2. request intake and fulfilment
3. incident logging, triage, and escalation
4. major incident management and communication
5. problem investigation and known-error management
6. change request, assessment, and approval
7. release and deployment
8. configuration and asset management
9. service level definition and reporting
10. knowledge article creation and review
11. end-user device lifecycle
