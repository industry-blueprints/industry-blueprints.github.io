...
1. Identity proofing and evidence validation
2. credential issuance and lifecycle
3. authentication service operation
4. role definition and entitlement design
5. access request and approval
6. provisioning and deprovisioning
7. privileged access management
8. periodic access review and recertification
9. federation and single sign-on
10. session and device management
11. alternative verification routes
12. account recovery
