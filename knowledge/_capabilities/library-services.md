...
description: Collections, digital access, public computing, and information help — the
  last public building anyone can enter without needing a reason.
resource: https://industry-blueprints.github.io/capabilities/library-services/
tags: [capability, libraries, collections, digital-access, public-computing, literacy, access]

generated: { by: human:jhofmann, at: 2026-07-28T20:45:00Z }
status: draft
...
relationships:
  ...
  - predicate: has_participant
    ...
    note: Anyone, without an appointment, an eligibility test, or a reason
  - predicate: has_participant
    target: /personas/knowledge-manager.md
    note: The discipline of organizing and surfacing information, practised professionally
---
...
**Government-service assistance is the measure most libraries do not capture and should.** It
