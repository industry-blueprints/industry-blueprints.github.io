...
description: Recording transactions to the ledger and producing statements that
  satisfy fund accounting, statutory deadlines, and an auditor.
resource: https://industry-blueprints.github.io/capabilities/accounting-and-financial-reporting/
tags: [capability, accounting, financial-reporting, fund-accounting, general-ledger]
...
relationships:
  ...
  - predicate: has_participant
    ...
    note: Relies on the ledger being the record rather than one of several
---
