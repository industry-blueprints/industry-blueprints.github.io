...
description: Turning intent into rules that are lawful, implementable, and
  understood by the people who have to apply them.
resource: https://industry-blueprints.github.io/capabilities/policy-development/
tags: [capability, policy, rulemaking, governance, implementation]
...
relationships:
  ...
  - predicate: has_participant
    ...
    note: Operationalizes the policy, and discovers what it failed to anticipate
  - predicate: has_participant
    target: /personas/elected-official.md
  - predicate: has_participant
    target: /personas/constituent.md
    note: Affected party, and consultee where participation is required
---
