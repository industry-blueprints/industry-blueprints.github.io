...
resource: https://industry-blueprints.github.io/capabilities/project-delivery-and-construction-management/
tags: [capability, construction, project-delivery, change-orders, contract-administration]

generated: { by: human:jhofmann, at: 2026-07-28T11:00:00Z }
status: draft
...
relationships:
  ...
  - predicate: has_participant
    ...
    note: A construction contract is a contract, and the same administration failures apply
  - predicate: has_participant
    target: /personas/supplier.md
    note: Designers and contractors, whose bid price reflects the risk the owner transfers
---
