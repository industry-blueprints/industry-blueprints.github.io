...
resource: https://industry-blueprints.github.io/capabilities/protest-and-dispute-resolution/
tags: [capability, protest, disputes, procurement, remedies, claims]
...
relationships:
  ...
  - predicate: has_participant
    ...
    note: The challenger, weighing a legitimate grievance against the cost of raising it
  - predicate: has_participant
    target: /personas/contract-manager.md
    note: Contract-phase disputes — performance, payment, and change
---
