...
description: Providing counsel to people who cannot afford it, at a caseload and
  resourcing level that permits an actual defense rather than a formal one.
resource: https://industry-blueprints.github.io/capabilities/indigent-defense/
tags: [capability, defense, public-defender, caseload, right-to-counsel, parity]
...
relationships:
  ...
  - predicate: has_participant
    ...
    note: The defender, carrying a caseload that frequently precludes doing the work properly
  - predicate: has_participant
    target: /personas/constituent.md
    note: The client, whose liberty depends on a service they did not choose and cannot change
---
