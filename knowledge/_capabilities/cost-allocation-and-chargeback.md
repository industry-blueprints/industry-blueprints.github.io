...
description: Distributing shared and indirect costs across programs, funds, and
  grants defensibly — the quiet determinant of whether grant funding pays its way.
resource: https://industry-blueprints.github.io/capabilities/cost-allocation-and-chargeback/
tags: [capability, cost-allocation, indirect-costs, chargeback, internal-service]
...
relationships:
  ...
  - predicate: has_participant
    ...
    note: Indirect recovery on awards depends entirely on this capability being credible
  - predicate: has_participant
    target: /personas/chief-information-officer.md
    note: Technology is the most commonly charged-back internal service, and the most disputed
---
