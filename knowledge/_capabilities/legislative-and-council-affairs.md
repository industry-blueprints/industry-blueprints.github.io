...
resource: https://industry-blueprints.github.io/capabilities/legislative-and-council-affairs/
tags: [capability, legislative, oversight, appropriations, governance]
...
relationships:
  ...
  - predicate: has_participant
    ...
    note: The other party — and the one whose information needs set the tempo
  - predicate: has_participant
    target: /personas/agency-director.md
  - predicate: has_participant
    target: /personas/budget-director.md
    note: Appropriations and fiscal notes run through this relationship
---
