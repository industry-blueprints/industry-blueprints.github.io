...
This capability supports responsible stewardship of public money and clear explanations of how resources are raised, allocated, and used. It gives leaders and staff a shared way to coordinate the work, make decisions visible, and understand whether it is producing the intended result.
...
1. Chart of accounts design and maintenance
2. journal entry and approval
3. subledger reconciliation
4. accounts payable and disbursement
5. fixed asset accounting
6. interfund transfers and eliminations
7. grant and project accounting
8. period close
9. year-end accrual and adjustment
10. statement preparation
11. audit support and adjustment posting
