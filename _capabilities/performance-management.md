...
description: Defining what success means, measuring it honestly, and changing something
  as a result — the last part being the one that usually fails.
...
1. Objective setting from strategy
2. measure definition and baselining
3. target setting
4. data collection and validation
5. periodic review
6. corrective action and reallocation
7. public reporting
8. measure retirement and revision
