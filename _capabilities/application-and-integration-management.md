...
This capability makes information and technology dependable, usable, protected, and available to the work that relies on them. It gives leaders and staff a shared way to coordinate the work, make decisions visible, and understand whether it is producing the intended result.
...
1. Application portfolio inventory and rationalization
2. business criticality and dependency assessment
3. integration inventory and interface design
4. API definition, publication, and versioning
5. data exchange standard adoption
6. environment and release management
7. vendor release and end-of-support tracking
8. technical debt assessment
9. legacy modernization planning
10. system retirement and data disposition
