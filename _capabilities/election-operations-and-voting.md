---
id: election-operations-and-voting
...
This capability helps a public agency exercise authority openly, lawfully, and accountably. It gives leaders and staff a shared way to coordinate the work, make decisions visible, and understand whether it is producing the intended result.
...
1. Ballot content assembly and district combination generation
2. proofing and logic and accuracy testing
3. ballot printing and distribution
4. polling place identification, contracting, and accessibility survey
5. precinct assignment and consolidation decisions
6. poll worker recruitment, training, and payment
7. equipment preparation, testing, sealing, and deployment
8. chain of custody for ballots and equipment
9. early voting operation
10. mail ballot application, issue, tracking, and return
11. signature verification and cure notification
12. provisional ballot issue and resolution
13. accessible voting provision
14. language assistance and translated materials
15. election day support and issue escalation
16. supply logistics
