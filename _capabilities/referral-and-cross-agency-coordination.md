...
1. Service directory maintenance across agencies and providers
2. needs identification at first contact
3. eligibility pre-screening for the receiving service
4. consent capture with defined scope
5. warm handoff and appointment scheduling
6. referral transmission and acknowledgement
7. outcome confirmation and loop closure
8. multi-agency case conferencing for complex cases
9. data sharing agreement establishment
10. unmet-need recording and escalation
11. directory accuracy verification
