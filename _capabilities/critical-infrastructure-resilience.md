...
1. Critical asset and system identification
2. consequence-of-failure assessment
3. dependency and interdependency mapping
4. single point of failure analysis
5. cascading failure scenario development
6. private operator engagement and information sharing
7. restoration priority negotiation across sectors
8. hardening and redundancy investment for owned assets
9. backup power and communications provision and testing
10. supply chain dependency assessment
11. operational technology security coordination with cybersecurity operations
12. exercise participation with operators
13. post-event dependency review
