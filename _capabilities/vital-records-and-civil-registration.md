...
This capability shapes how people and organizations experience public services, requests, and decisions. It gives leaders and staff a shared way to coordinate the work, make decisions visible, and understand whether it is producing the intended result.
...
1. Birth registration from hospitals, midwives, and home births
2. paternity acknowledgement and parentage recording
3. death registration from providers, medical examiners, and funeral homes
4. cause-of-death certification and query resolution
5. fetal death registration
6. marriage licence issue and return
7. divorce decree recording
8. delayed and late registration for events never registered
9. amendment and correction
10. court-ordered changes including adoption and gender marker
11. sealing and re-registration for adoption
12. certificate application, entitlement verification, and issue
13. fraud control and security paper management
14. fee assessment and waiver
15. genealogical and non-certified access after the confidentiality period
16. data supply to public health and statistics
