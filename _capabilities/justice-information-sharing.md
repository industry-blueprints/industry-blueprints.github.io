---
id: justice-information-sharing
...
1. Person identification and biometric matching across agencies
2. arrest reporting to the state repository
3. disposition reporting from courts to the repository
4. custody and release status exchange
5. warrant entry, service, and clearance
6. protective order registration and service status
7. criminal history query and response
8. background check response for employment and licensing
9. incident and offence statistical reporting
10. access authorization, training, and audit under the applicable security policy
11. information sharing agreement negotiation and maintenance
12. sealing and expungement propagation
13. record challenge and correction
14. cross-agency analytical data provision
