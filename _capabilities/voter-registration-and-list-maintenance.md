...
1. Registration intake — online, by mail, in person, at motor vehicle and public assistance agencies
2. eligibility verification against identity and citizenship sources
3. duplicate detection and merge
4. address standardization and validation
5. district and precinct assignment from the address
6. change of address and name processing
7. interstate and intrastate transfer
8. list maintenance against death, felony status, and change-of-address data
9. notice and waiting-period compliance before removal
10. challenge and provisional resolution
11. voter record lookup and self-service correction
12. address confidentiality programme handling
13. registration statistics reporting
14. pre-registration of minors approaching eligibility
