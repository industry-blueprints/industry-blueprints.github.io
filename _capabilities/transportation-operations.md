...
1. Traffic signal operation, timing, and retiming
2. traffic monitoring and management centre operation
3. incident detection, response, and clearance
4. traveller information publication
5. work zone traffic control planning and permitting
6. special event traffic management
7. winter and weather operations
8. transit service planning, scheduling, and dispatch
9. transit real-time information
10. fare collection
11. sign, marking, and signal maintenance coordination
12. safety analysis and countermeasure selection
13. speed and volume data collection
