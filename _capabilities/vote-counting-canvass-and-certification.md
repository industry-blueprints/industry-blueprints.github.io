---
id: vote-counting-canvass-and-certification
...
1. Ballot receipt and reconciliation
2. signature and eligibility resolution before tabulation
3. tabulation of in-person, early, mail, and provisional ballots
4. adjudication of ambiguous marks under published standards
5. duplicate ballot creation for damaged ballots
6. provisional resolution and counting
7. reconciliation of ballots issued, returned, counted, and rejected
8. unofficial results reporting and update cadence
9. post-election audit — risk-limiting or fixed-percentage
10. canvass and official result compilation
11. challenge and contest handling
12. recount conduct
13. certification
14. results transmission to the state
15. audit log and record retention
16. public observation management
