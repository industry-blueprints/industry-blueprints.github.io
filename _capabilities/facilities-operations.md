...
This capability supports the physical assets and operating environments through which many public services are delivered. It gives leaders and staff a shared way to coordinate the work, make decisions visible, and understand whether it is producing the intended result.
...
1. Occupant Request Intake and Resolution — how a report gets from an occupant to whoever can act on it, and why safety and comfort can't share a queue. Compliance Inspection Scheduling and Certification Tracking — keeping fire, elevator, backflow, and accessibility certifications current across every building the organization runs. Also: space inventory and allocation
2. utilization measurement
3. move, add, and change management
4. security operations, access control, and screening
5. energy and utility management and procurement
6. cleaning and janitorial service delivery
7. grounds and snow operations
8. building systems operation
9. emergency preparedness for the building
10. lease administration in coordination with property management
